...
const filepath = 'c:\\Users\\786\\Desktop\\Cava menu\\cava_bowl_post.html';
...
const new_content = content.replace(/<style>[\s\S]*?<\/style>/, \`<style>\n\${new_css}\n    </style>\`);

fs.writeFileSync(filepath, new_content, 'utf8');
console.log("Updated successfully via Node.js");
